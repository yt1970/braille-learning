...
const IDIOMS = [
  ...
  {text:'イッシンフラン',   meaning:'一心不乱'},   {text:'イクドウオン',   meaning:'異口同音'},
  {text:'イッショウケンメイ',meaning:'一生懸命'},  {text:'インガオウホウ',     meaning:'因果応報'},
  ...
  {text:'テンシンランマン', meaning:'天真爛漫'},   {text:'バジトウフウ',       meaning:'馬耳東風'},
  ...
  {text:'ジコムジュン',     meaning:'自己矛盾'},   {text:'チギョウゴウイツ',   meaning:'知行合一'},
  {text:'セイテンノヘキレキ', meaning:'青天の霹靂'}, {text:'ドクダンセンコウ', meaning:'独断専行'},
  ...
  {text:'ケンドジュウライ',meaning:'捲土重来'},  {text:'コウトウムケイ',   meaning:'荒唐無稽'},
